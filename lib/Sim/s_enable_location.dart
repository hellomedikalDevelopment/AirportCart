import 'package:airportcart/Sim/s_not_found.dart';
import 'package:airportcart/Sim/sim_store_details.dart';
...
class SimEnableLocation extends StatefulWidget {
  @override
  _SimEnableLocationState createState() => _SimEnableLocationState();
}

class _SimEnableLocationState extends State<SimEnableLocation> {
            ...
            customButton(
              ...
              onTap: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => SimStoreDetails()));
              },
            ),
            SizedBox(height: 15),
            customButton(
