import 'package:airportcart/Sim/s_choose_location.dart';
...
class SimNotFound extends StatefulWidget {
  @override
  _SimNotFoundState createState() => _SimNotFoundState();
}

class _SimNotFoundState extends State<SimNotFound> {
                ...
                customButton(
                  ...
                  onTap: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => SimChooseLocation()));
                  },
                ),
              ],
            ),
