...
class SimChooseLocation extends StatefulWidget {
  @override
  _SimChooseLocationState createState() => _SimChooseLocationState();
}

class _SimChooseLocationState extends State<SimChooseLocation> {
