...
class BusinessChooseLocation extends StatefulWidget {
  @override
  _BusinessChooseLocationState createState() => _BusinessChooseLocationState();
}

class _BusinessChooseLocationState extends State<BusinessChooseLocation> {
              ...
              sufixImage: IconButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => BusinessLoungePage()));
                  })),
          SizedBox(height: 10),
          Padding(
