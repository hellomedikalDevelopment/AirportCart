import 'package:airportcart/Business_Lounge/complete_table_business.dart';
...
class BusinessPaymentPage extends StatefulWidget {
  @override
  _BusinessPaymentPageState createState() => _BusinessPaymentPageState();
}
  ...
  void initState() {
    ...
    Future.delayed(Duration(seconds: 4), () {
      Navigator.push(context,
          MaterialPageRoute(builder: (context) => CompleteTableBusinessPage()));
    });
  }
