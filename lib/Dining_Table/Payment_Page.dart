import 'package:airportcart/Dining_Table/Table_Booking/Complete_table_booking.dart';
...
class PaymentProssesPage extends StatefulWidget {
  @override
  _PaymentProssesPageState createState() => _PaymentProssesPageState();
}

class _PaymentProssesPageState extends State<PaymentProssesPage> {
  @override
  void initState() {
    super.initState();
    Future.delayed(Duration(seconds: 4), () {
      Navigator.push(context,
          MaterialPageRoute(builder: (context) => CompleteTabaleBookingPage()));
    });
  }
