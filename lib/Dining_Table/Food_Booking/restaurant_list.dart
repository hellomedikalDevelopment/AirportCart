...
import 'package:airportcart/Dining_Table/Food_Booking/resturant_view.dart';
import 'package:airportcart/Dining_Table/Food_Booking/search.dart';
...
class FoodRestaurantListPage extends StatefulWidget {
  FoodRestaurantListPage({this.controller});
  TextEditingController controller;
  @override
  _FoodRestaurantListPageState createState() => _FoodRestaurantListPageState();
}

class _FoodRestaurantListPageState extends State<FoodRestaurantListPage> {
                ...
                InkWell(
                  onTap: () {
                    ...
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => FoodResturantViewPage()));
                  },
                  child: Container(
                    padding: EdgeInsets.all(10),
                    decoration: BoxDecoration(
