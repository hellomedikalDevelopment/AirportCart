import 'package:airportcart/Sim/s_more_details.dart';
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                appText(title: '\$ 30.00', color: AppData.black, fontSize: 14),
              ],
            ),
            SizedBox(height: 10),
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                appText(title: 'Sim Name:', color: AppData.grey, fontSize: 14),
                appText(
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                appText(title: 'Documents Verify:', color: AppData.grey, fontSize: 14),
                appText(title: 'Verified', color: AppData.green, fontSize: 14),
              ],
            ),
            SizedBox(height: 5),
            Row(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                appText(title: 'Documents Verify:', color: AppData.grey, fontSize: 14),
                appText(title: 'Processing', color: AppData.yellow, fontSize: 14),
              ],
            ),
            SizedBox(height: 5),
            Row(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                appText(title: 'Documents Verify:', color: AppData.grey, fontSize: 14),
                appText(title: 'Cancelled', color: AppData.red, fontSize: 14),
              ],
            ),
            SizedBox(height: 5),
            Row(
