...
class CurrencyExchangeLocation extends StatefulWidget {
  @override
  _CurrencyExchangeLocationState createState() =>
      _CurrencyExchangeLocationState();
}

class _CurrencyExchangeLocationState extends State<CurrencyExchangeLocation> {
