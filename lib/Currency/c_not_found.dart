...
class CurrencyNotFound extends StatefulWidget {
  @override
  _CurrencyNotFoundState createState() => _CurrencyNotFoundState();
}

class _CurrencyNotFoundState extends State<CurrencyNotFound> {
                    ...
                    customButton(
                      ...
                      onTap: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => CurrencyChooseLocation()));
                      },
                    ),
                  ],
                ),
