...
import 'package:airportcart/Currency/c_not_found.dart';
...
class CurrencyEnableLocation extends StatefulWidget {
  @override
  _CurrencyEnableLocationState createState() => _CurrencyEnableLocationState();
}

class _CurrencyEnableLocationState extends State<CurrencyEnableLocation> {
            ...
            customButton(
              ...
              onTap: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => CurrencyNotFound()));
              },
            ),
